...
copy knows from '/home/daniel/Documents/Programming/duckdb-pgq/data/csv/sf1/Person_knows_Person.csv' (HEADER, DELIMITER '|');

insert into knows select target, source from knows;

copy person from '/home/daniel/Documents/Programming/duckdb-pgq/data/csv/sf1/Person.csv' (HEADER);
