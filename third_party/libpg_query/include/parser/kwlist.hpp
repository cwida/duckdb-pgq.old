...
PG_KEYWORD("columns", COLUMNS, RESERVED_KEYWORD)
...
PG_KEYWORD("destination", DESTINATION, RESERVED_KEYWORD)
...
PG_KEYWORD("node", NODE, RESERVED_KEYWORD)
...
PG_KEYWORD("properties", PROPERTIES, RESERVED_KEYWORD)
PG_KEYWORD("property", PROPERTY, RESERVED_KEYWORD)
...
PG_KEYWORD("relationship", RELATIONSHIP, RESERVED_KEYWORD)
...
PG_KEYWORD("struct", STRUCT, COL_NAME_KEYWORD)
