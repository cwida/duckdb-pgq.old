...
EDGE TABLES ( Person_knows_Person KEY ( personid ) SOURCE KEY ( Person1Id ) REFERENCES Person DESTINATION KEY ( Person2Id ) REFERENCES Person LABEL Person_knows_Person );
